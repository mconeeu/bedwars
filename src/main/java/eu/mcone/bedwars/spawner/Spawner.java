                    ...
                    while (i <= 6) {
                        try{
                        	if(i == 6) {
	                        	...
	                        	if(!(Factory.getConfigLocationNoWorld("Spawner.gold." + i, Utils.yCfgSpawner) == null)){
	                           	...
	                           	}else if(!(Factory.getConfigLocationNoWorld("Spawner.Gold." + i, Utils.yCfgSpawner) == null)){
	                           		for(Player all : Bukkit.getOnlinePlayers()) {
	                           			all.getWorld().dropItemNaturally(getConfigLocationNoWorld("Spawner.Gold." + i, Utils.yCfgSpawner), new ItemStack(Material.GOLD_INGOT));
	                           			
	                           			Particle test = new Particle(EnumParticle.CRIT_MAGIC, getConfigLocationNoWorld("Spawner.Gold." + i, Utils.yCfgSpawner), 1, 1, 1, 1, 20);
	                        			test.sendToAll(all);
	                           		}
	                           	}else {
	                           		for(Player all : Bukkit.getOnlinePlayers()) {
                	...
                	while (i <= 6) {
                        try{
                        	if(i == 6) {
	                        	...
	                        	if(!(Factory.getConfigLocationNoWorld("Spawner.iron." + i, Utils.yCfgSpawner) == null)){
	                        		for(Player all : Bukkit.getOnlinePlayers()) { 
	                           	...
	                           	}else if(!(Factory.getConfigLocationNoWorld("Spawner.Iron." + i, Utils.yCfgSpawner) == null)){
	                           		for(Player all : Bukkit.getOnlinePlayers()) {
	                           			all.getWorld().dropItemNaturally(getConfigLocationNoWorld("Spawner.Iron." + i, Utils.yCfgSpawner), new ItemStack(Material.IRON_INGOT));
                	...
                	while (i <= 6) {
                        try{
                        	if(i == 6) {
	                        	...
	                        	if(!(Factory.getConfigLocationNoWorld("Spawner.bronze." + i, Utils.yCfgSpawner) == null)){
	                        		for(Player all : Bukkit.getOnlinePlayers()) { 
	                           	...
	                           	}else if(!(Factory.getConfigLocationNoWorld("Spawner.Bronze." + i, Utils.yCfgSpawner) == null)){
	                           		for(Player all : Bukkit.getOnlinePlayers()) {
	                           			all.getWorld().dropItemNaturally(getConfigLocationNoWorld("Spawner.Bronze." + i, Utils.yCfgSpawner), new ItemStack(Material.CLAY_BRICK));
